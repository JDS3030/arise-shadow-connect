...
| 5.4 | ✅ Conectar **auto-deploy** Vercel↔GitHub (cada `git push` a `master` publica solo). *Verificado 2026-07-09: deployment `source: git`, production branch `master`.* | 🟢 | ⏱️ | Bajo |
